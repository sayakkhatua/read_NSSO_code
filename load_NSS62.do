* Loading Data for NSS 62 Round

local datadir "~/Google Drive/India NSS/data"
cd "`datadir'/raw/NSS62/Data/"
set more off
set trace on
...
forvalues s=1/8 {
	local snames "`snames'MH`s'C01.TXT "
}
!cat `snames' > NSS62raw.txt  
...
local level2var						///
	...
	str religion 			54-54 	///
	str soc_grp 			55-55 	///
	str land_possess		56-57	///
	str dwell_unit			58-58	///
	str dwell_type			59-59	///
	str struc_type			60-60	///
	str area_covered		61-68	///
	str cook_code			69-69	///
	str light_code			70-70	///
	str mpce				71-78	///
...
local level3var					///
	...
	str sex   			44-44 	///
	str age   			45-47 	///
	str marital_stat  	48-48	///
	str educ   			49-50 	///
	str days_away   	51-52 	///
	str meal_daily   	53-53 	///
	str meal_school   	54-55	///
	str meal_employer 	56-57 	///
	str meal_other   	58-59 	///
	str meal_pay   		60-61 	///
	str meal_home   	62-63
...
local level7var								///
	str item_code   				40-42 	///
	str no_dos						43-45	///
	str firsthand_purchase_no		46-48 	///
	str hire_purchase   			49-49 	///
	str firsthand_purchase365  		50-57 	///
	str cost2   					58-65 	///
	str sechand_purchase_no   		66-68	///
	str sechand_purchase365   		69-76	///
	str total_expense365   			77-84
...
forvalues l=1/7 {
	infix `commonvar' `level`l'var' using NSS62raw.txt if level=="0`l'", clear
	...
	save "`datadir'/dta/NSS62/level`l'", replace
}
