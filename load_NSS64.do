* Loading Data for NSS 64 Round


local datadir "~/Google Drive/India NSS/data"
cd "`datadir'/raw/NSS64/Data/"
set more off
set trace on
...
forvalues s=1/8 {
	local snames "`snames'AH`s'C01.TXT "
}
!cat `snames' > NSS64raw.txt
...
local level2var						///
	...
	str religion 			53-53 	///
	str soc_grp 			54-54 	///
	str land_possess		55-56	///
	str dwell_unit			57-57	///
	str dwell_type			58-58	///
	str struc_type			59-59	///
	str area_covered		60-67	///
	str cook_code			68-68	///
	str light_code			69-69	///
	str mpce				70-77	///
	str perf_ceremony		78-78	///
	str meal_nonhh			79-82	///
	str ration				83-83
...
local level7var								///
	 item_code   				39-41 	///
	 no_dos						42-44	///
	 firsthand_purchase_no		45-47 	///
	 hire_purchase   			48-48 	///
	 firsthand_purchase365  	49-56 	///
	 cost2   					57-64 	///
	 sechand_purchase_no   		65-67	///
	 sechand_purchase365   		68-75	///
	 total_expense365   		76-83
...
forvalues l=1/7 {
	infix `commonvar' `level`l'var' using NSS64raw.txt if level=="0`l'", clear
	...
	save "`datadir'/dta/NSS64/level`l'", replace
}
