* Loading Data for NSS 57 Round

local datadir "~/Google Drive/India NSS/data"
cd "`datadir'/raw/NSS57/Data/"
set more off
set trace on

forvalues s=1/4 {
	local snames "`snames'WRK570`s'.TXT "
}

!cat `snames' > NSS57raw.txt
...
local commonvar					///
	...
	str soc_grp			61-61	///
	str land_pos		62-63	///
	str dwell_unit		64-64	///
	str dwell_type		65-65	///
	str struc_type		66-66	///
	str area_covered	67-69	///
	str cook_code		70-71	///
	str light_code		72-72	///
	str meal_out		73-73	///
	str per_ceremony	74-74	///
	str pds_purchase	75-75
...
local workfile1					///	
	...
	str mon11			97-98	///
	str mon12		 	99-100	///
	str tot_mon_nofood	101-102	///
	str ask_ques		103-103	///
	str time_canvas		104-106	///
	str person_no		107-109	///
	str relation		110-110	///
	str sex				111-111	///
	str age				112-113	///
	str marital_stat	114-114	///
	educ			115-116	///
	str upst_code		117-118	///
	str upnic_code		119-120	///
	str sbst_code		121-122	///
	str sbnic_code		123-124	///
	str cwst_code		125-126	///
	str cwnic_code		127-128	///
	str days_away		129-130	///
	str meal_daily		131-131	///
	str meal_school		132-133	///
	str meal_employer	134-135	///
	str meal_other		136-137	///
	str meal_pay		138-139	///
	str meal_home		140-141	///
	str lot				142-146

local workfile2					///
	str time_canvas		76-78	///
	str item_code		79-81	///
	str first_hand		82-89	///
	str sec_hand		90-97	///
	str total_val		98-105	///
	str food_code		106-106	///
	str use_durables	107-109	///
	str lot				110-114
...
forvalues l=1/2 {
	infix `commonvar' `workfile`l'' using NSS57raw.txt if id=="W`l'", clear
	...
	save "`datadir'/dta/NSS57/id`l'", replace
}
